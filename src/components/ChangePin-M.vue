<template>
  <div>
    <div class="card shadow-nm" style="border-radius: 25px;min-height:88vh">
      <div class="card-body">
        <h5 @click="linkTo('profile')" class="font-weight-bold mb-0"><i class="fas fa-arrow-left mr-4"></i>
          Change
          Pin</h5>
        <div class="row mt-5">
        ...
        <!-- ConfirmPin -->
        <form v-if="pinConfirmed === false" action="" @submit.prevent="alertCode()" class="my-5">
          <div class="row">
            ...
            <div class="col-12 col-lg-6 col-md-10">
              ...
              <button class="btn btnSub font-weight-bold w-100 p-2 mt-4 border-0">
                Continue
              </button>
            </div>
            <div class="d-none d-md-block d-lg-block col-3 col-lg-3 col-md-1"></div>
