        ...
        <div class="col-lg-6 col-md-6 pr-0">
          <div class="card shadow-nm" style="border-radius: 25px">
            <div class="card-body">
              ...
              <div v-if="transUser.length > 0" class="mt-2 hideScroll" style="overflow-y: scroll; height: 70vh">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="text-center">
              <button type="submit" class="btn btnMain font-weight-bold px-4 w-25 mr-2" style="border-radius: 10px">
                Continue
              </button>
              <button type="button" @click="$bvModal.hide('modalTopUp')"
                class="btn btnSecondary font-weight-bold px-4 w-25 ml-2" style="border-radius: 10px">
                Cancel
              </button>
            </div>
          </div>
