<template>
  <div class="col-md-6 bg" style="padding-left: 7%; padding-right: 10%">
    <router-link to="/">
      <h3 class="pt-5 text-left" style="color: #ffffff">AFA-Wallet</h3>
    </router-link>
    ...
    >
      AFA-Wallet is an application that focussing in banking needs for all users in
      the world. Always updated and always following world trends. 5000+ users
      registered in AFA-Wallet everyday with worldwide users coverage.
    </p>
  </div>
</template>
