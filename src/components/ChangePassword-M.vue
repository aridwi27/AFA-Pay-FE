<template>
  <div>
    <div class="card shadow-nm" style="border-radius: 25px;min-height:88vh">
      <div class="card-body ">
         <h5 @click="linkTo('profile')" class="font-weight-bold mb-0"><i class="fas fa-arrow-left mr-4"></i> Change
          Password</h5>
        <p class="text-secondary pr-4 mb-2 mt-5">
          You must enter your current password and then type your new password
          twice.
        </p>
        <form action="" @submit.prevent="onChange" >
          <div class="row">
            ...
            <div class="col-10 col-md-6 col-lg-6">
              ...
              <button
                class="btn btnMain font-weight-bold w-100 p-3 mt-4 border-0"
