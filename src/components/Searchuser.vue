<template>
  <div
    class="card shadow p-4 border-0"
    ...
    <div>
      ...
      <form action="">
        <div class="form-group">
          <i
            class="fa fa-search position-absolute pl-3"
            style="color: #bdbbbb; padding-top: 10px"
          ></i>
          <input
            class="mt-3 form-control border-0"
            style="background: #f5f5f5; border-radius: 10px; padding-left: 40px"
            type="text"
      ...
      <div
        v-for="user in sampleUser"
        :key="user.id"
        class="row card shadow-sm border-0 mt-2 p-2 mx-2"
      >
        <div class="d-flex ml-2">
          <img width="50px" :src="user.image" alt="image" />
          <div class="ml-2">
            <span style="font-weight: 800" class="d-block">{{
              user.name
            }}</span>
